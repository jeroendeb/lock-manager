 ...
 */
metadata {
    definition (name: "Z-Wave Lock Schlage", namespace: "ethayer", author: "SmartThings", , runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, genericHandler: "Z-Wave") {
		capability "Actuator"
		capability "Lock"
		capability "Polling"
		capability "Refresh"
